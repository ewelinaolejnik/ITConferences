...
namespace ITConferences.UnitTests.Controllers
{
    ...
    public class ConferencesControllerTests
    {
        ...
        [TestCategory("ConferencesController")]
        [Owner("Ewelina Olejnik")]
        public void ConferencesController_Manage_updates_conference_object()
        {
            //Arrange
            sut.Manage("1,3", "1,3", conferences[0],null);
        ...
        {
            //Arrange
            _repositoryMock.Setup(e => e.GetById<Conference>(0, null)).Returns(conferences[0]);
            ...
            var viewDataCountry = ((SelectList) sut.ViewData["Countries"]).ToList();
            var expectedDataCountry =
                new SelectList(_repositoryMock.Object.GetAll<Country>(), "CountryID", "Name").ToList();
