...
namespace ITConferences.WebUI
{
    ...
    {
        public ApplicationUserManager(IUserStore<Attendee> store)
            : base(store)
        {
        }
            ...
            IOwinContext context)
        {
            ...
            manager.UserValidator = new UserValidator<Attendee>(manager)
            {
    ...
    public class ApplicationSignInManager : SignInManager<Attendee, string>
    {
